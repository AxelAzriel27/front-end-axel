...
let countriesAkhiranSia = countries.filter((country) =>
  country.endsWith("sia")
);
console.log(countriesAkhiranSia);
...
// let output = countries.filter((country) => country.length > 7);
// console.log(output);
